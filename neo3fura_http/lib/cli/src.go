...
// QueryFind fetches documents without counting total. Use for cursor-based
// pagination where total count is not needed on subsequent pages.
func (me *T) QueryFind(args struct {
	Collection string
	Index      string
	Sort       bson.M
	Filter     bson.M
